        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/all-dondathang')}}">Đơn đặt hàng</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/all-khachhang')}}">Chi tiết khách hàng</a></li>
                ...
                <li  class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li><a href="{{URL::to('/all-tintuc')}}">Xem tin</a></li>
                    </ul>
                </li>
                <li  class="sub-menu">
                    <a href="fontawesome.html">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/all-lienhe')}}">Chi tiết liên hệ</a></li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/all-binhluan')}}">Bình luận của khách hàng</a></li>
